...
import styles from './Teacher-SignupForm.module.css';
        ...
        <>
            <div className={styles.pageContainer}>
                <section className={styles.flexSection1}>
                    <div className={styles.write1}>강사 회원가입</div>
                </section>
                ...
                <form className={styles.formContainer}>
                    ...
                    <h1 className={styles.logintext}>강사 정보</h1>
                    <div className={styles.anyLogins}>
                        <input
                        ...
                        />
                        <h2 className={styles.infoes}>년차 강사입니다.</h2>
                    </div>
